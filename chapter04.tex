...
В листинге~\ref{annotation-pois-example} приведен пример фрагмента аннотации, в котором описываются несколько <<точек интереса>>, такие как <<class\_name>>, <<method\_name>> и <<if\_condition>>.
