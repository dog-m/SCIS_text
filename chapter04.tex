...
Команды, доступные пользователю при описании алгоритма инструментирования в секции $algorithm$ аннотации грамматики.

\begin{itemize}
  \item $insert-text (text)$ -- 11
  \item $insert-call (function, params)$ -- 22
  \item $insert-fragment ([each-line-prefix], [each-line-postfix])$ -- 33
  \item $create-variable ([name], type, value$ -- 44
  \item $deconstruct-variable (type, variant)$ -- 55
  \item $fragment-to-variable (name, type, [each-line-prefix], [each-line-postfix])$ -- 66
\end{itemize}
